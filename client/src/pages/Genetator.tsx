...
const Genetator = () => {
  ...
  const handleGenerate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!productImage || !modelImage || !name || !productName || !aspectRatio)
      return toast("Please fill all the required dields");
  ...
  return (
    <div className="min-h-screen text white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          heading="Creating In-Context Image"
          description="Upload your model and product images to generates stunning User Generated Content, Short-form videos and social media posts."
        />
