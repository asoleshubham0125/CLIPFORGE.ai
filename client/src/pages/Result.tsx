      ...
      <div className="max-w-6xl mx-auto">
        <header className="flex justify-between items-center mb-8">
          ...
          >
            ...
            <p className="maxx-sm:hidden">New Generation</p>
          </Link>
        </header>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="glass-pannel inline-block p-2 rounded-2xl">
              <div
                className={`${project?.aspectRatio === "9:16" ? "aspect-9/16" : "aspecct-video"} sm:max-h-200 rounded-xl bg-gray-900 overflow-hidden relative`}
              >
              ...
              <div className="flex flex-col gap-3">
                <a href={project.generatedImage} download>
                  <GhostButton
                    ...
                    className="w-ful justify-center rounded-md py-3 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
